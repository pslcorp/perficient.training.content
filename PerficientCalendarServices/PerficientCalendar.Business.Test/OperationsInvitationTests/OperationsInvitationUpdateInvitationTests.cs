...
public class OperationsInvitationUpdateInvitationTests
{
    ...
    public OperationsInvitationUpdateInvitationTests()
    {
    ...
    public async Task Update200TestAsync()
    {
        ...
        InvitationRepositoryMock.Setup(x => x.GetById(It.IsAny<Guid>())).ReturnsAsync(new InvitationDTO());
        ...
        InvitationRepositoryMock.Setup(x => x.Upsert(It.IsAny<InvitationDTO>())).ReturnsAsync(new InvitationDTO());
        var response = await Operations.UpdateInvitation(new Invitation());
        Assert.Equal(200, response.StatusCode);
    }

    [Fact]
    public async Task Update404InvitationTestAsync()
    {
